...
#define Ra Ra_km
 double Ra = 0.001;
#define ntau_km _thread1data[0]
#define ntau _thread[_gth]._pval[0]
#define ninf_km _thread1data[1]
	...
	Prop *_prop;
{
 ...
 _mechtype = nrn_get_mechtype(_mechanism[1]);
  ...
  hoc_register_dparam_size(_mechtype, 4);
 	...
 	ivoc_help("help ?1 km /home/ximing/Documents/lab_stuff/synpr/mechanisms/i686/km.mod\n");
