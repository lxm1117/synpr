...
#define cao cao_ca
 double cao = 2.5;
#define htau_ca _thread1data[0]
#define htau _thread[_gth]._pval[0]
#define hinf_ca _thread1data[1]
#define hinf _thread[_gth]._pval[1]
#define mtau_ca _thread1data[2]
#define mtau _thread[_gth]._pval[2]
#define minf_ca _thread1data[3]
#define minf _thread[_gth]._pval[3]
#define q10 q10_ca
 double q10 = 2.3;
#define tadj_ca _thread1data[4]
	...
	Prop *_prop;
{
 ...
 _mechtype = nrn_get_mechtype(_mechanism[1]);
  ...
  hoc_register_dparam_size(_mechtype, 4);
 	...
 	ivoc_help("help ?1 ca /home/ximing/Documents/lab_stuff/synpr/mechanisms/i686/ca.mod\n");
